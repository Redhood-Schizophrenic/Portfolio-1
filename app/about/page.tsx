      ...
      <div className="flex flex-col items-center">
        <div className="md:w-1/2 md:pl-8">
          <p className="text-lg mb-4">
            I'm <span className='font-semibold'> Co-Owner of Appniche Technologies, </span> a software company dedicated to creating innovative solutions for businesses and individuals. Striving towards becoming Übermensch.
          </p>
          <p className="text-lg mb-4">
            With 3+ of experience in software development, I specialize in creating robust, scalable applications that solve real-world problems.
          </p>
          <p className="text-lg">
